...
function receivePacket(isHost, senderId, packet)
	...
	-- DebugPrint(action)
	-- DebugPrint(#packetDecoded.names)
	if (action == 1 or action == 2) and isHost and (not amIhost) then
		tdmpModsAction(action, packetDecoded.ids, packetDecoded.names)
